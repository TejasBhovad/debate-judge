...
export const POST = async (req, res) => {
  try {
    ...
    const { memberId, properties } = await req.json();
    ...
    member.ranking = properties.ranking;
    member.debateScore = properties.debateScore;
    member.platformScore = properties.platformScore;
    member.feedback = properties.feedback;
